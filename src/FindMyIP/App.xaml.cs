...
using FindMyIP.Resources;
using FindMyIP.Services;
using FindMyIP.Views;
...
using DebugLogger = FindMyIP.Services.DebugLogger;
using FindMyIP.ViewModels;
...
namespace FindMyIP
{
    public partial class App : PrismApplication
    {
        ...
        protected override async void OnInitialized()
        {
            ...
            await NavigationService.NavigateAsync("/CustomNavigationPage/SplashScreenPage");
        }
